...
const int POS_Y_TART_MAIN_OBJECT = 475;
...
const int SPEED_THREAT = 7;
const int POS_Y_TART_THREAT_OBJECT = 472;

//Bullet Object
const int SPEED_BULLET_MAIN_OBJECT = 20;
const int SPEED_BULLET_THREATS_OBJECT = 15;
...
//Name Main
static char g_name_main[]               = {"sold2.png"};
static char g_name_main1[]              = {"pl1.png"};
static char g_name_explosion_main[]     = {"exp_main.png"};
static char g_name_bullet_main_1[]      = {"sphere2.png"};
static char g_name_bullet_main_2[]      = {"laser.png"};
static char g_name_audio_bullet_main1[] = {"Fire.wav"};
static char g_name_audio_bullet_main2[] = {"Laser.wav"};
static char g_name_audio_ex_main[]      = {"Explosion+1.wav"};

//Name Threats
static char g_name_threats[]            = {"stone_man4450.png"};
static char g_name_bullet_threats[]     = {"bl1.png"};
static char g_name_explosion_threat[]   = {"exp.png"};
static char g_name_audio_ex_threats[]   = {"Bomb1.wav"};

//Name Background
static char g_name_background[]         = {"bk8.png"};
...
namespace SDLCommonFunc
{
  ...
  void ApplySurfaceClip(int x, int y, SDL_Surface* source, SDL_Surface* destination, SDL_Rect* clip = NULL) ;
  void CleanUp();
